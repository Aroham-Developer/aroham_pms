...
class Invoice_payments extends MY_Controller {
    ...
    function save_payment() {
        ...
        validate_submitted_data(array(
            ...
            "invoice_payment_amount_inr" =>"required",
            "invoice_payment_fee"=>"required",
            "invoice_payment_fee_inr"=>"required",
            "gst"=>"required"
        ...
        $invoice_payment_data = array(
            ...
            "amount_inr" => $this->input->post('invoice_payment_amount_inr'),
            "fee" => $this->input->post('invoice_payment_fee'),
            "fee_inr" => $this->input->post('invoice_payment_fee_inr'),
    ...
    private function _make_payment_row($data) {
        ...
        return array(
            ...
            $data->amount_inr,
            to_currency($data->fee, $data->currency_symbol),
            $data->fee_inr,
            $data->gst,
