...
<div class="modal-body clearfix">
    ...
    <div class="form-group">
        <label for="invoice_payment_amount_inr" class=" col-md-3"><?php echo lang('amount_inr'); ?></label>
        <div class="col-md-9">
            <?php
            echo form_input(array(
                "id" => "invoice_payment_amount_inr",
                "name" => "invoice_payment_amount_inr",
                "value" => $model_info->amount_inr ? to_decimal_format($model_info->amount_inr) : "",
                "class" => "form-control",
                "placeholder" => lang('amount_inr'),
                "data-rule-required" => true,
                "data-msg-required" => lang("field_required"),
            ));
            ?>
     ...
     <div class="form-group">
        <label for="invoice_payment_fee" class=" col-md-3"><?php echo lang('fee'); ?></label>
        <div class="col-md-9">
            <?php
            echo form_input(array(
                "id" => "invoice_payment_fee",
                "name" => "invoice_payment_fee",
                "value" => $model_info->fee ? to_decimal_format($model_info->fee) : "",
                "class" => "form-control",
    ...
    <div class="form-group">
        <label for="invoice_payment_fee_inr" class=" col-md-3"><?php echo lang('fee_inr'); ?></label>
        <div class="col-md-9">
            <?php
            echo form_input(array(
                "id" => "invoice_payment_fee_inr",
                "name" => "invoice_payment_fee_inr",
                "value" => $model_info->fee_inr ? to_decimal_format($model_info->fee_inr) : "",
                "class" => "form-control",
                "placeholder" => lang('fee_inr'),
                "data-rule-required" => true,
                "data-msg-required" => lang("field_required"),
            ));
            ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var payment_amount_inr=$("#invoice_payment_amount_inr");
        payment_amount_inr.keyup(function(){
        var gst =(payment_amount_inr.val()*18)/100;
            // var gst_calculation=+payment_amount_inr.val() + +gst;
        $("#gst").val(gst);
        });
    });
</script>